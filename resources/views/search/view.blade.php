...
<!-- <div class="sliderss">
            <div><img src="https://sorgalla.com/jcarousel/examples/_shared/img/img2.jpg" title="Title of image1"></div>
            <div><img src="https://sorgalla.com/jcarousel/examples/_shared/img/img3.jpg" title="Title of image2"></div>
            <div><img src="https://sorgalla.com/jcarousel/examples/_shared/img/img5.jpg" title="Title of image3"></div>
        </div> -->
...
$guests="";
                                                                    ...
                                                                    <select class="form-control text-16"  id="front-search-guests" name="guests">
                                                                        @for($i=1;$i<=16;$i++)
                                                                        <option value="{{ $i }}" <?php if($guests == $i){ echo "selected";}?>> {{ ($i == '16') ? $i.'+ '.trans('messages.home.guest') : $i.' '.trans('messages.property_single.guest') }}</option>
                                                                        @endfor
                                                                    </select>
                                                                </div>
                                                            </div>
                ...
                <div class="row mt-4">
                    <div id="loader" class="display-off loader-img position-center">
                        <img src="{{URL::to('/')}}/public/front/img/new-loader.gif" alt="loader">
                    </div>
                </div>
...
function showpanel2() {     
                        $('.sliderss').bxSlider({
                            ...
                            speed: 1000
                                     ...
                                     $( ".bx-prev"  ).fadeTo( "slow", 0.33 );
                        $( ".bx-prev" ).hover(function() {
                          $( this ).fadeTo( "slow", 6.33 );
  ...
  // showpanel2();     
                        ...
                        for (var key in properties) {
                            if (properties.hasOwnProperty(key)) {
                                room_point[key] = {
                                    ...
                                    content: '<a href="'+APP_URL+'/properties/'+properties[key].id+'?checkin='+checkin+'&checkout='+checkout+'&guests='+guest+'" class="media-cover" target="_blank">'
                                    ...
                                    if (divCol == false) {
                                        room_div += '<div class="col-md-6 col-lg-3 p-2 pl-4 pr-4 mt-4">'
                                                    +'<div class="card h-100">'
                                                        +'<div class="grid">'
                                                            +'<a href="'+APP_URL+'/properties/'+properties[key].id+'?checkin='+checkin+'&checkout='+checkout+'&guests='+guest+'" target="_blank">'
                                                        ...
                                                        +'<div class="card-body p-0 pl-1 pr-1">'
                                                            +'<div class="d-flex">'
                                                                ...
                                                                +'<div class="p-2 text">'
                                                                    +'<a class="text-color text-color-hover" href="'+APP_URL+'/properties/'+properties[key].id+'?checkin='+checkin+'&checkout='+checkout+'&guests='+guest+'" target="_blank">'
            ...
            // jQuery.ajax({
            //     url: 'http://bnbtoronto.ca/api/search/images/' + properties[key].id,
            //     type:'GET',
...
function readString(filename){
    ...
    jQuery.ajax({
                async: false,
                url: 'http://bnbtoronto.ca/api/search/images/' + filename,
                type:'GET',
                success:function(dataphoto){
                  //ajaxCallBack(dataphoto);
                  keyValue = dataphoto;
                },
                complete: function(){
 ...
 var retVal = readString(properties[key].id);
...
// var p1 = 31;
// <?php 
// $id = "' + document.writeln(p1) + '";
// $_noturl = "http://bnbtoronto.ca/api/search/images/".$id; 

//      $content =file_get_contents($_noturl);
//      $result  = json_decode($content);

// ?>

//var showidsss = showids(properties[key].id);
                                        ...
                                        room_div +='<div class="col-sm-6 col-md-12 col-lg-12  p-0 mb-4">'
                                                    +'<div class=" row  border p-2 rounded-3">'
                                                        +'<div class="col-lg-4 p-2">'
                                                            +'<div class="img-event">'+ retVal +'</div>'
                                                        +'</div>'
...
//             jQuery.ajax({
//                 url: 'http://bnbtoronto.ca/api/search/images/' + str,
//                 type:'GET',
