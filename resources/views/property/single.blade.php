	...
	<div class="item active">
		...
		<!--popup slider end-->
						@if(count($property_photos) > 0)
							<div class="row mt-4">
								<div class="col-md-12 col-sm-12 pl-3 pr-3" style="padding-top: 40px;">
									<div class="row">
										@php $i=0 @endphp
										
										@foreach($property_photos as $row_photos)
											@if($i == 0)
												<div class="col-md-6 col-sm-12 mb-2 mt-2 p-2">
											...
											@elseif($i <= 4)
												@if($i==4) 
													<div class="col-md-2 col-sm-4 mt-2 p-2">
														<div class="view-all">
															<img src="{{url('public/images/property/'.$property_id.'/'.$row_photos->photo)}}" alt="property-photo" class="img-fluid rounded" onclick="lightbox({{$i}})" />
		...
		<div class="col-lg-8 col-xl-9">
			<div  id="sideDiv">
				<div class="d-flex border rounded-4 p-4 mt-4">
					...
					<div class="col-md-8">
						@if($result->property_description->youtubelink != "")
					    <span style="float:right;padding-top:30px;">
					    	<a href="{{ $result->property_description->youtubelink }}">Virtual Tour</a></span>
					    @endif
					</div>
				</div>
							...
							<div class="js-subtotal-container booking-subtotal panel-padding-fit">
								...
								<table class="table table-bordered price_table" id="booking_table">
									...
									<tr class ="additional_price"> 
										...
										<td class="pl-4">{!! $result->property_price->currency->symbol !!}<span  id="additional_guest" value=""> 0 </span></td>
									</tr>
									...
									<tr class = "security_price"> 
										...
										<td class="pl-4">{!! $result->property_price->currency->symbol !!}<span  id="security_fee" value=""> 0 </span></td>
									</tr>
									...
									<tr class = "cleaning_price"> 
										...
										<td class="pl-4">{!! $result->property_price->currency->symbol !!}<span  id="cleaning_fee" value=""> 0 </span></td>
									</tr>
									...
									<tr>
										...
										<td class="pl-4">{!! $result->property_price->currency->symbol !!} <span  id="discount" value=""> 0 </span></td>
									</tr>
...
<ul class="list-inline text-center d-flex align-items-center justify-content-center">
								...
								<li class="list-inline-item">
									<a href="{{ url('users/show/'.$result->host_id) }}" class="btn vbtn-outline-success text-14 font-weight-700 mt-3 pl-5 pr-5 pt-3 pb-3"  target="_blank">
								Contact Host
							</a>
								</li>
...
<!-- <div class="container-fluid container-fluid-90 mt-70">
	...
	<div class="container-fluid container-fluid-90 mt-70 mb-5">
		@if(count($similar)!= 0)
			<div class="row">
				<div class="col-md-12">
					<h2 class="text-center-sm text-20 font-weight-700">More Places to Stay<!-- {{trans('messages.property_single.similar_list')}} --></h2>
				</div>
			</div>
						...
						<div class="card h-100 border card-1">
							...
							<div class="card-body p-0 pl-1 pr-1">
								<div class="d-flex">
									...
									<div class="p-2 text">
										<a class="text-color text-color-hover" href="{{ url('properties/'.$row_similar->id) }}">
