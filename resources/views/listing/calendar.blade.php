		...
		<div class="col-md-10">
			...
			<div class="main-panel min-height mt-4">
				<div class="row justify-content-center">
					...
					<div class="col-md-9 mt-sm-0 pl-4 pr-4"><a href="{{ url('properties/'.$property_id) }}" style="font-size: 18px;float: right" target="_blank">Preview Listing</a>
						...
						<div class="row justify-content-between mt-4 mb-5">
							...
							<div class="mt-4">
							<a  data-prevent-default="" href="{{ url('properties/'.$result->id) }}" class="btn vbtn-outline-success text-16 font-weight-700 pl-5 pr-5 pt-3 pb-3" id="btn_next">
...
<script src="{{ url('public/js/front.min.js') }}"></script>
