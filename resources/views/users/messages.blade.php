	...
	<div class="message-footer">
		<div class="row">
			...
			<div class="col-md-3">
				<a href="javascript:void(0)" class="btn btn-success text-18 " data-booking="{{$booking->id}}" data-receiver="{{ $booking->$users->id }}" data-property="{{ $booking->property_id }}"><i class="fa fa-images" aria-hidden="true"></i></a>
			</div>
			<div class="col-md-3">
					<a href="javascript:void(0)" class="btn btn-success btn-save-message text-18 " data-booking="{{$booking->id}}" data-receiver="{{ $booking->$users->id }}" data-property="{{ $booking->property_id }}"><i class="far fa-envelope" aria-hidden="true"></i></a>
			</div>
