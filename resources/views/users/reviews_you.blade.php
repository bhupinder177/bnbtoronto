                                ...
                                <div class="tab-content">
                                            ...
                                            <div class="row mt-4 border w-100 rounded-3">
                                                <div class="col-md-3 col-xl-4 pl-0 pr-0">
                                                    <div class="img-event p-3">
                                                        <a href="{{ url('/') }}/properties/{{ $writeReview->properties->id }}">
                                                            <img class="img-fluid rounded" src="{{ $writeReview->properties->cover_photo }}" alt="img">
                                                        </a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-9 col-xl-8 pl-2 pr-2">
                                                    <div class="row align-items-center mt-4">
                                                        <div class="col-md-12 p-0">
                                                            <a href="{{ url('/') }}/properties/{{ $writeReview->properties->id }}"><p class="font-weight-700 mb-0">{{$writeReview->properties->name }}</p></a>
                                    ...
                                    <div class="tab-pane {{ $you ?? ' '}}" id="tabs-2" role="tabpanel">
                                        ...
                                        <div class="row mt-4 border rounded">
                                            <div class="col-md-3 col-xl-4 pl-0 pr-0">
                                                <div class="img-event p-3">
                                                    <a href="{{ url('/') }}/properties/{{ $pastReview->properties->id }}">
                                                        <img class="img-fluid rounded" src="{{ $pastReview->properties->cover_photo }}" alt="img">
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-9 col-xl-8 pl-2 pr-2">
                                                <div class="row align-items-center mt-2">
                                                    <div class="col-md-12 p-0">
                                                        <a href="{{ url('/') }}/properties/{{ $pastReview->properties->id }}"><p class="font-weight-700 text-18 mb-0">{{ $pastReview->properties->name }} </p></a>
                                    ...
                                    <div class="tab-pane {{ $expired ?? ' '}}" id="tabs-3" role="tabpanel">
                                        ...
                                        <div class="row mt-4 border w-100 rounded">
                                            <div class="col-md-3 col-xl-4 pl-0 pr-0">
                                                <div class="img-event p-3">
                                                    <a href="{{ url('/') }}/properties/{{ $expired->properties->id }}">
                                                        <img class="img-fluid rounded" src="{{ $expired->properties->cover_photo }}" alt="img">
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-9 col-xl-8 pl-2 pr-2">
                                                <div class="row align-items-center mt-4">
                                                    <div class="col-md-12 p-0">
                                                        <a href="{{ url('/') }}/properties/{{ $expired->properties->id }}"><p class="font-weight-700 mb-0"> {{$expired->properties->name}}</p></a>
                                                    </div>
