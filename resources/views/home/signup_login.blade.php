...
<div class="container mb-4 margin-top-85 min-height">
    <div class="d-flex justify-content-center">
		<div class="p-5 mt-5 mb-5 border w-450 login-bk">
				...
				<!-- <p class="text-center font-weight-700 mt-1">SIGNUP FORM</p> -->
				<form id="signup_form" name="signup_form" method="post" action="{{url('create')}}" class='signup-form login-form' accept-charset='UTF-8' onsubmit="return ageValidate();">    
					...
					<div class="row text-16">
						<div class="form-group col-sm-12 p-0">
								<h5 class="title_login">Welcome to <span class="orange">BNB Toronto</span></h5>
			<p style="font-size: 13px;margin-bottom: 20px">Create your account by filling the form below.</p>
				<!-- 			<p style="font-weight: bold;padding-left: 5px;">Are you a ?</p> -->
							<select name="user_type"  class="form-control  input-field">
						...
						<div class="form-group col-sm-12 p-0">
							...
							<input type="text" class='form-control text-14 p-2  input-field' value="{{ old('first_name') }}" name='first_name' id='first_name' placeholder='{{ trans('messages.sign_up.first_name') }}'>
						</div>

						<div class="form-group col-sm-12 p-0">
								@if ( $errors->has('last_name') ) <p class="error-tag">{{ $errors->first('last_name') }}</p> @endif
								<input type="text" class='form-control text-14 p-2  input-field' value="{{ old('last_name') }}" name='last_name' id='last_name' placeholder='{{ trans('messages.sign_up.last_name') }}'>
						</div>

						<div class="form-group col-sm-12 p-0">
								<input type="text" class='form-control text-14 p-2  input-field' value="{{old('email')}}" name='email' id='email' placeholder='{{ trans('messages.login.email') }}'>
								@if ($errors->has('email')) 
									<p class="error-tag">
									{{ $errors->first('email') }}
									</p> 
						...
						<div class="form-group col-sm-12 p-0"> 
								<input type="tel" class="form-control text-14 p-2  input-field" id="phone" name="phone" required="">
						...
						<div class="form-group col-sm-12 p-0">
								...
								<input type="password" class='form-control text-14 p-2  input-field' name='password' id='password' placeholder='{{ trans('messages.login.password') }}'>
						</div>
						...
						<div class="form-group col-sm-12 p-0">
								<div class="row">
									<div class="col-sm-4 pl-0 mt-2">
											<select name='birthday_month' class='form-control text-14 p-2 input-field' id='user_birthday_month'>
									...
									<div class="col-sm-4 mt-2">
										<select name='birthday_day' class='form-control text-14 input-field' id='user_birthday_day'>
									...
									<select name='birthday_year' class='form-control text-14 input-field' id='user_birthday_year'>
	...
	<div class="form-group col-sm-12 p-0">
								...
								<input type="checkbox" class='form-control ' style="height: 15px!important;margin-top: 7px;" name='newsletter' required=""> <span class="text-13" >I have agree to accept newsletter from BNBToronto</span> 

								<div class="text-13" style="margin-top: 20px">
									By signing in or creating an account, you agree with our <a href="http://bnbtoronto.ca/terms-and-conditions" class="orange">Terms & Conditions</span> and <span class="orange">Privacy Statement</a>.
								</div>
						</div>
						<button type='submit' id="btn" class="btn vbtn-outline-success   button-reactangular text-15  w-100"> <i class="spinner fa fa-spinner fa-spin d-none" ></i>
    ...
    </div><center><p class="signup">{{trans('messages.sign_up.already')}} {{ $site_name }} {{ trans('messages.sign_up.member') }}?
					<a href="{{URL::to('/')}}/login?" >
					{{trans('messages.sign_up.login')}}</span>
				</a></p></center>
</div>
