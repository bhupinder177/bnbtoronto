...
<div class="content-wrapper">
                ...
                <div class="box">
                    ...
                    <form class="form-horizontal" action="{{url('admin/edit-customer')}}/{{$user->id}}" id="edit_customer" method="post" name="signup_form" accept-charset='UTF-8'>
                        ...
                        {{ csrf_field() }}
                         <div class="row">
                        <div class="col-sm-3">
                        <center><img src="http://bnbtoronto.ca/public/images/profile/{{$user->id}}/{{$user->profile_image}}" style="width: 200px;margin-bottom:20px;">
                            <p><a class="btn btn-info" href="http://bnbtoronto.ca/users/show/{{$user->id}}" target="_blank" style="font-size: 18px">View Profile</a></p></center>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                 ...
                                 <select class="form-control" name="usertype" id="usertype">
                                        <option value="host" {{$user->user_type == 'host' ? 'selected' : ''}}>Host</option>
  ...
  <div class="form-group" id="reasontext">
                                <label for="exampleInputPassword1" class="control-label col-sm-3">Reason</label>
                                <div class="col-sm-5">
                                    <textarea name="reasontext" class="form-control"></textarea>
                                </div>
