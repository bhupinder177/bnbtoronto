	...
	<div class="content-wrapper">
		<section class="content-header">
			<a href="../properties" id="hostbtn" class="btn btn-primary" style="margin-left: 15px;">{{$totalprop}}<br>Total Properties</button>

<a href="unlisted" id="hostbtn" class="btn btn-warning" style="margin-left: 15px;">{{$totalpropunlisted}}<br>Unlisted Properties</a>

<a href="new" id="hostbtn" class="btn btn-success" style="margin-left: 15px;">{{$totalpropnew}}<br>New Properties</a>

<a  href="onhold" id="hostbtn" class="btn btn-danger" style="margin-left: 15px;">{{$totalproponhold}}<br>Onhold Properties</a>
