    ...
    <div class="row">
      ...
      <div class="box-body">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <label class="label-large">Order by</label>
              <select name="homeshow" id="basics-select-recomended" class="form-control">
                  <option value="0" {{ ( $result->homeshow == 0) ? 'selected' : '' }}>0</option>
                  <option value="1" {{ ( $result->homeshow == 1) ? 'selected' : '' }}>1</option>
                  <option value="2" {{ ( $result->homeshow == 2) ? 'selected' : '' }}>2</option>
                  <option value="3" {{ ( $result->homeshow == 3) ? 'selected' : '' }}>3</option>
                  <option value="4" {{ ( $result->homeshow == 4) ? 'selected' : '' }}>4</option>
              </select>
            </div> 
          </div>
          <div class="row">
