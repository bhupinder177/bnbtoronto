...
if($result['hostbackground']==null)
{
    $hostbackgroundpath = "public/front/images/default-error-image.png";
}
else {
    $hostbackgroundpath = 'public/front/images/logos/'.$result['hostbackground'];
}

if($result['guestbackground']==null)
{
    $guestbackgroundpath = "public/front/images/default-error-image.png";
}
else {
    $guestbackgroundpath = 'public/front/images/logos/'.$result['guestbackground'];
}
		...
		'fields' => [ 
            ...
            ['type' => 'file', 'class' => '', 'label' => 'Logo', 'name' => "photos[logo]", 'value' => '', 'image' => url($logoPath), 'custom_span' =>$result['logo'], 'custom_company_logo' => $result['logo']] ,
              ...
              ['type' => 'select', 'options' => $language, 'class' => 'validate_field', 'label' => 'Default Language', 'name' => 'default_language', 'value' => $result['default_language']],
               ...
               ['type' => 'file', 'class' => '', 'label' => 'Host Background', 'name' => "photos[hostbackground]", 'value' => '', 'image' => url($hostbackgroundpath), 'custom_span3' =>$result['hostbackground'], 'custom_host_background' => $result['hostbackground']] ,

                ['type' => 'file', 'class' => '', 'label' => 'Guest Background', 'name' => "photos[guestbackground]", 'value' => '', 'image' => url($guestbackgroundpath), 'custom_span4' =>$result['guestbackground'], 'custom_guest_background' => $result['guestbackground']] ,
            ...
            $('#general_form').validate({
                rules: {
                    ...
                    'photos[favicon]': {
                     ...
                     'photos[guestbackground]': {
                        //extension: "jpg|png|jpeg"
                        accept: "image/jpg,image/jpeg,image/png,image/gif"
                        //accept: "image/*"
                    },
                     'photos[hostbackground]': {
                        //extension: "jpg|png|jpeg"
                        accept: "image/jpg,image/jpeg,image/png,image/gif"
                        //accept: "image/*"
                    },
