...
<!-- Modal -->
<div class="modal fade z-index-medium" id="onhold-warning-modal" role="dialog">
	<div class="modal-dialog">
		<!-- Modal content-->
		<div class="modal-content w-100-p h-100-p">
			<div class="modal-header">
			...
			<form method="get" id="myFormId" action="">
			...
			<div class="modal-body">
				...
				<p></p>
				<p id="whyonhold1">Reasons : (Do you want to proceed?)</p>
				<textarea id="whyonhold" name="whyonhold" class="form-control" col=140 rows=10></textarea>
...
<!-- Modal -->
<div class="modal fade z-index-medium" id="cancel-warning-modal" role="dialog">
	<div class="modal-dialog">
		<!-- Modal content-->
		<div class="modal-content w-100-p h-100-p">
			<div class="modal-header">
			...
			<form method="get" id="myFormIdcancel" action="">
			...
			<div class="modal-body">
				...
				<p></p>
				<p id="whyonhold1">Reasons : (Do you want to proceed?)</p>
				<textarea name="whyonhold3" class="form-control" col=140 rows=10></textarea>
...
$(document).on('click', '.cancel-warning', function(e){
	e.preventDefault();
	var url = $(this).attr('href');
	//$('#onhold-modal-yes').attr('href', url)
	$('#myFormIdcancel').attr('action',url);
	$('#cancel-warning-modal').modal('show');
	
});

$(document).on('click', '.onhold-warning', function(e){
	e.preventDefault();
	var url = $(this).attr('href');
	//$('#onhold-modal-yes').attr('href', url)
	$('#myFormId').attr('action',url);
	$('#onhold-warning-modal').modal('show');
});
