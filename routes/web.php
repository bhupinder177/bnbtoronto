...
Route::group(['middleware' => ['locale']], function () { 
	...
	// Route::post('search/images', 'SearchController@getimages');
...
Route::get('emailtest', 'LoginController@emailtest');
//Auth::routes();
...
Route::get('properties/users', 'CustomerController@customerprop')->middleware(['permission:customers']);
	...
	Route::match(array('GET', 'POST'), 'add-chat-filter', 'CustomerController@addchat');
	...
	Route::group(['middleware' => 'permission:edit_customer'], function () {
		...
		Route::match(array('GET', 'POST'), 'delete-customer/{id}', 'CustomerController@delete');
	...
	Route::get('properties/{id}', 'PropertiesController@index')->middleware(['permission:properties']);
	...
	Route::get('onhold-property/{id}/{hostid}', 'PropertiesController@onhold')->middleware(['permission:delete_property']);

	Route::get('bookings', 'BookingsController@index')->middleware(['permission:manage_bookings']);
	Route::get('bookings/{status}', 'BookingsController@index')->middleware(['permission:manage_bookings']);
	...
	Route::get('bookings/statuschange/{id}', 'BookingsController@cancelbooking')->middleware(['permission:manage_bookings']);
	...
	Route::get('messages/messages_list_csv', 'AdminController@messagesCsv');
	...
	Route::get('settings/reasons', 'SettingsController@reasonlist');
	Route::get('settings/add-reasons', 'SettingsController@addReason');
	Route::get('settings/edit-reasons/{id}', 'SettingsController@addReason');
	Route::get('settings/reasons/delete/{id}', 'SettingsController@delete');


	Route::get('settings/add', 'SettingsController@add');
...
Route::match(array('GET', 'POST'), 'settings/social-links-delete/{id}', 'SettingsController@socialLinksdelete')->middleware(['permission:social_links']);

		Route::match(array('GET', 'POST'), 'settings/add-social-links', 'SettingsController@addsocialLinks')->middleware(['permission:social_links']);
...
Route::group(['middleware' => ['guest:users', 'locale']], function () {
	...
	Route::get('booking/report/{id}', 'TripsController@reportc');
    // Messaging
    Route::match(['get', 'post'], 'inbox', 'InboxController@index');
    Route::match(['get', 'post'], 'inbox/{id}', 'InboxController@index');
    Route::post('messaging/savemessage/', 'InboxController@savemessage');
    Route::post('messaging/getsavemsg/', 'InboxController@getsavemsg');
    Route::post('messaging/editsavemsg/', 'InboxController@editsavemsg');
    Route::post('messaging/saveformmsg/', 'InboxController@saveformmsg');
    Route::post('messaging/savefilter/', 'InboxController@savefilter');
...
Route::match(['GET', 'POST'], 'admin/chat', 'Admin\CustomerController@chatfilter');
