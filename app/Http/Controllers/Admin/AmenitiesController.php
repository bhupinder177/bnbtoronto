...
class AmenitiesController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        $amenities = Amenities::where('title',$request->title)->first();
        if($amenities){
             $this->helper->one_time_message('error', 'Warning, Duplicate Amenities Title');
                //return redirect('admin/amenities');
                return redirect('admin/add-amenities');
            }else{
