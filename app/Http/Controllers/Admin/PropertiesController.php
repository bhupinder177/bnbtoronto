...
class PropertiesController extends Controller
{
    ...
    public function index(PropertyDataTable $dataTable,Request $request)
    {
    ...
    public function listing(Request $request, CalendarController $calendar)
    {
        ...
        if ($step == 'basics') {
            if ($request->isMethod('post')) {
                ...
                $property->homeshow           = $request->homeshow;
                $property->save();
       ...
       public function onhold(Request $request)
    {
        ...
        //  }
        $whyonholds="";
        if(isset($request->whyonhold)){
            $whyonholds = $request->whyonhold;
        }
                $properties = Properties::find($request->id);
                $properties->status       = $request->statustype;
                $properties->whyonhold       = $whyonholds;
                $properties->save();

         return redirect('admin/customer/properties/'.$request->hostid);  
    }
