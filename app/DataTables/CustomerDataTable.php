...
class CustomerDataTable extends DataTable
{
    public function ajax()
    {
        return datatables()
            ...
            ->addColumn('action', function ($users) {
                ...
                $edit = \Helpers::has_permission(Auth::guard('admin')->user()->id, 'edit_customer') ?'<a href="' . url('admin/edit-customer/' . $users->id) . '" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;<a href="' . url('admin/delete-customer/' . $users->id) . '" class="btn btn-xs btn-danger"><i class="glyphicon glyphicon-trash"></i></a>' : '';
            ...
            // })
                ->addColumn('first_name', function ($users) {
                return ucfirst($users->first_name);
            })
                ->addColumn('last_name', function ($users) {
            ...
            // })
            ->rawColumns([ 'formatted_phone','action'])
            ->make(true);
    }
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->addColumn(['data' => 'user_type', 'name' => 'user_type', 'title' => 'Type'])
            ->addColumn(['data' => 'first_name', 'name' => 'first_name', 'title' => 'First Name', 'searchable' => true])
            ->addColumn(['data' => 'last_name', 'name' => 'last_name', 'title' => 'Last Name', 'searchable' => true])
            ...
            ->addColumn(['data' => 'reasons', 'name' => 'reasons', 'title' => 'Reasons', 'orderable' => false, 'searchable' => true])
