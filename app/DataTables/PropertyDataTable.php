...
class PropertyDataTable extends DataTable
{
    public function ajax()
    {
        ...
        return datatables()
            ...
            ->addColumn('action', function ($properties) {
                ...
                if (Common::has_permission(\Auth::guard('admin')->user()->id, 'delete_property')) {
                    $onhold = '<a href="' . url('admin/onhold-property/' . $properties->properties_id.'/'.$properties->host_id) . '" class="btn btn-xs btn-warning onhold-warning" style="margin-left:3px;"><i class="glyphicon glyphicon-exclamation-sign" ></i></a>';
                }
                return $edit . $delete . $onhold;
            })
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->addColumn(['data' => 'whyonhold', 'name' => 'properties.whyonhold', 'title' => 'Reasons'])
